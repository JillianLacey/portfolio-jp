...
import videoTest from "../media/test.mp4";
            ...
            <div id="work">
                <div className="container">
                    <div className="row project work-bg">
                        <video className="d-block img-fluid col-md-8 project-img" src={canvasVid} controls></video>
                    ...
                    <div className="row project work-bg">
                        <video className="d-block img-fluid col-md-8 project-img" src={songsterVid} controls></video>
                        <div className="col-md-4" id="project-info">
                    ...
                    <div className="row project work-bg">
                        <video className="d-block img-fluid col-md-8 project-img" src={gabbleVid} controls></video>
                        <div className="col-md-4" id="project-info">
                    ...
                    <a href="https://github.com/JillianPichocki" className="view-more" target="_blank">View More On Github >></a>
                </div>
            </div>
        )
    }
